...
namespace hei {
    ...
    template <typename T>
/*
 * The T is a placeholder for the type of elements that the SharedBuffer will hold.
 * This means you can create a SharedBuffer for any data type, such as SharedBuffer<int>,
 * SharedBuffer<char>, etc.
 * */
    class SharedBuffer {
    public:
        typedef T               valueType;
