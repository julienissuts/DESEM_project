...
//The inline keyword suggests to the compiler that the function entity() should be inlined, replacing calls to the function with the actual code of the function
